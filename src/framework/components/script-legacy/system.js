        ...
        _preRegisterInstance: function (entity, url, name, instance) {
            if (entity.script) {
                ...
                if (entity.script.data._instances[name]) {
                    throw Error(("Script name collision '{0}'. Scripts from '{1}' and '{2}' {{3}}", name, url, entity.script.data._instances[name].url, entity.getGuid()));
                }
                ...
                if (entity.script.data._instances) {
                    ...
                    for (instanceName in entity.script.instances) {
                        ...
                        if (entity.script[instanceName]) {
                            throw Error(("Script with name '{0}' is already attached to Script Component", instanceName));
                        } else {
