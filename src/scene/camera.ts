namespace pc {
     ...
     */
    export class Camera {
        _projection: any; // some enum
        _nearClip: number;
        _farClip: number;
        _shaderParams: Float32Array;
        _fov: number;
        _orthoHeight: number;
        _aspect: number;
        _aspectRatioMode: any;
        _horizontalFov: boolean;
        frustumCulling: boolean;
        cullingMask: number; // long int 0xffffffff
        _renderDepthRequests: number;
        _projMatDirty: boolean;
        _projMat: pc.Mat4;
        _viewMat: pc.Mat4;
        _viewProjMat: pc.Mat4;
        vrDisplay: any;
        _rect: {};
        _scissorRect: {};
        frustum: pc.Frustum;
        ...
        _clearOptions: any;
        _node: any;
        calculateTransform: any;
        overrideCalculateTransform: boolean;
        calculateProjection: any;
        overrideCalculateProjection: boolean;
        _cullFaces: boolean;
        _flipFaces: boolean;
        _component: any;
         ...
         */
        worldToScreen(worldCoord: pc.Vec3, cw: number, ch: number, screenCoord: pc.Vec3) {
         ...
         */
        screenToWorld(x: number, y: number, z: number, cw: number, ch: number, worldCoord: pc.Vec3) {
