...
namespace pc {
    export namespace events {
         ...
         * pc.events.attach(obj);
         */
        export function attach<T>(target: T): T & IEvents {
            var result: T & IEvents = target as any;
            result.on = on;
            result.off = off;
            result.fire = fire;
            result.once = once;
            result.hasEvent = hasEvent;
            result._callbackActive = { };
            return result;
        }
        ...
        export function fire<T extends IEvents>(this: T, name: string, arg1?: any, arg2?: any, arg3?: any, arg4?: any, arg5?: any, arg6?: any, arg7?: any, arg8?: any): T {
         ...
         */
        export function hasEvent<T extends IEvents>(this: T, name: string): boolean {
